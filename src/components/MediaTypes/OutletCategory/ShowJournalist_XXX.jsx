...
const ShowJournalists = () => {
  ...
  const { isdata, loading, loadMore, loadingMore } = useLeftJournoSearch(
    ...
    url +
      `?OutletFilter=${id}&Editor_Columnis_Bureau_Filter=Anchor&pageSize=60&`,
    searchDeps
  );
      ...
      <div className="section w-11/12 p-6 pb-6 pl-8 pr-0 pt-0">
              ...
              <div className="flex flex-col">
                <ul className="flex items-center gap-x-1 pb-4 text-sm text-gray-400">
                  <li className="flex items-center">
                    <Link to={`/media-types`} className="hover:text-gray-700">
                      Media Types
                    </Link>
                  ...
                  {outletId === "14" && (
                    <>
                      ...
                      <li className="flex items-center">
                        <Link
                          to={`/mediaTypeOutlet/14/Broadcast`}
                          className="hover:text-gray-700"
                        >
                          Broadcast
                        </Link>
                    ...
                    outletCategory?.map((curNav, index) => {
                      if (curNav?.categoryType?.includes(Number(outletId))) {
                        return (
                          <li key={index}>
                            <Link
                              to={`/${curNav?.url}/${outletId}/${id}/${name}`}
        ...
        {isOpen && (
          <BuildCampaign
            ...
            Editor_Columnis_Bureau_Filter="Anchor"
            open={isOpen}
...
export default ShowJournalists;
