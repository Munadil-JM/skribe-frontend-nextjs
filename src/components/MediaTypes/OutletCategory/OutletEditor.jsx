...
const outletCategory = [
  ...
  },
  {
    ...
    tabName: "Editor",
    url: "OutletEditor",
    categoryType: [1, 2, 5, 6, 13, 16, 20, 22],
  },
  {
    id: 2,
    tabName: "Bureau Chief",
    url: "BureauChief",
    categoryType: [1, 2, 5, 22],
  },
  {
    id: 3,
    tabName: "Columnist",
...
const OutletEditor = ({ outletId, id, name }) => {
  ...
  const { isdata, loading, loadMore, loadingMore } = useLeftJournoSearch(
    ...
    url +
      `?OutletFilter=${id}&Editor_Columnis_Bureau_Filter=Editor&SearchFilter=${searchByText}&pageSize=60&`,
    searchDeps
  );
                  ...
                  <>
                    ...
                    >
                      ...
                      {selectedJournalistsLength !== 0 && (
                        <div
                          id="selectCount"
                          className="absolute flex h-9 w-9 items-center justify-center rounded-2xl bg-[#002b5b] text-center align-middle text-sm font-bold text-[#002B5B]"
                        >
      ...
      <div className="section w-11/12 p-6 pb-6 pl-8 pr-0 pt-0">
        ...
        {isOpen && (
          <BuildCampaign
            ...
            Editor_Columnis_Bureau_Filter="Editor"
            open={isOpen}
