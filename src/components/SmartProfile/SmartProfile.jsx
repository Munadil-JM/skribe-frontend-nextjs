      ...
      <div className="px-8 py-3 xl:w-11/12 w-12/12 xl:pl-8 section">
        <div className="flex flex-col justify-between mx-2 md:items-center md:mx-10 md:flex-row">
          ...
          <div className="flex justify-start gap-2 mt-4 md:mt-0">
            ...
            {!isLoadingJournalistProfile &&
              ...
              journalistProfileError === null && (
                <input
                  ...
                  className="flex cursor-pointer items-center whitespace-nowrap rounded-[5px] border border-[#8260b6]  px-3 py-1 text-xs  text-[#8260b6]"
                  // href="/customcrm"
                  onClick={() =>
            ...
            {journalistProfileError === null && (
              <div
                className="cursor-pointer py-1 px-4 rounded-[5px] border-[#333333] border-[1px] flex justify-center items-center text-xs   text-[#8260b6]"
