...
// import { Card, Button, Flex, Text, Input, Box, Select } from "@chakra-ui/react";
...
const BeatWatch = () => {
  ...
  return (
    <>
      ...
      <fieldset className="border-2 border-black/10 rounded-[10px] p-2 mb-4 bg-white -mt-2">
        ...
        <div className="flex flex-row flex-wrap items-center lg:justify-end gap-2 mx-2 mt-2 mb-2 text-sm">
          ...
          <div className="border border-black/20 bg-gray-100 rounded-[5px]">
            <select
              className="py-1 px-2 border-0 text-xs text-gray-500 cursor-pointer rounded-md"
          ...
          <div className="flex flex-row gap-2 items-center">
            <div className="border border-black/20 rounded-[5px]">
              <input
                className="text-black/40 text-[13px] xl:w-[120px] bg-gray-100 w-full p-1 rounded-md"
                type="date"
                value={startDate}
            ...
            <div className="border items-center border-black/20 bg-gray-100 rounded-[5px]">
              <input
                className="text-black/40 text-[13px] xl:w-[120px] bg-gray-100 w-full p-1 rounded-md"
                type="date"
                value={endDate}
        ...
        <div className="flex flex-wrap gap-2 mx-2 mt-2 mb-2">
          {selectedBeats?.map((beat, index) => (
            <div
              ...
              className="flex items-center justify-center px-2  mt-1 border border-gray-400 rounded-md"
              variant="unstyled"
            >
              <div align="center" className="flex gap-x-1 items-center">
                <div className=" text-sm text-gray-500">{beat}</div>

                <span
                  className="icon-16 text-gray-500 material-icons-outlined cursor-pointer"
