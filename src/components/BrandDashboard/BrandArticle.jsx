...
const BrandArticle = ({
  ...
  const articlesPerPage = 20; // Assuming 10 articles per page
              ...
              <Fragment key={index}>
                <div className="flex flex-col justify-between gap-4 mx-2 mt-2 mb-2 xl:items-center xl:flex-row">
                  ...
                  <div className="xl:mx-2">
                    {ele?._source?.vchsentiment === "positive" && (
                      <div className="w-20 py-1 tracking-wider text-center rounded-[2px] border border-green-600 text-green-600">
                    ...
                    {ele?._source?.vchsentiment === "neutral" && (
                      <div className="w-20 py-1  tracking-wider text-center rounded-[2px]  border border-yellow-500 text-yellow-500">
                        <p className="text-[10px] font-medium">
                          {ele?._source?.vchsentiment?.toUpperCase()}
                        </p>
                      </div>
                    )}
                    {ele?._source?.vchsentiment === "negative" && (
                      <div className="w-20 py-1 tracking-wider text-center rounded-[2px] font-[500] border border-red-500 text-red-500">
                        <p className="text-[10px] font-medium">
                          {ele?._source?.vchsentiment?.toUpperCase()}
                        </p>
                      </div>
